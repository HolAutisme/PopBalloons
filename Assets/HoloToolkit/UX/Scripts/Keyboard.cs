...
namespace HoloToolkit.UI.Keyboard
{
    ...
    public class Keyboard : Singleton<Keyboard>
    {
        ...
        //Callback view before keyboard
        private GameObject callbackView;
        ...
        // Custom method to add callback view;
        public void SetCallbackView(GameObject view)
        {
            callbackView = view;
        }
        ...
        public void FunctionKey(KeyboardKeyFunc functionKey)
        {
            switch (functionKey.m_ButtonFunction)
            {
                case KeyboardKeyFunc.Function.Enter:
                    {
                        Enter();
                        callbackView.GetComponent<UIController>().Show();
                        break;
                    }
